          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <div className="ms-3 flex items-center">
                ...
                <div
                  className={`top-15 fixed right-2 top-12 z-50 ${showDropdownUser ? '' : 'hidden'} list-none divide-y divide-gray-100 rounded bg-white text-base shadow dark:divide-gray-600 dark:bg-gray-700`}
                  id="dropdown-user"
                >
          ...
          <ul class="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span class="ms-3">So dữ liệu gốc</span>
              </Link>
            </li>
            <li>
              <a
